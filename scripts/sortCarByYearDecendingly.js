...
sortCarByYearDescendingly(carsDataDescending);
...
function sortCarByYearDescendingly(cars) {
  ...
  result.sort((old, young) => young.year - old.year);

  // Tulis code-mu disini
  for (let i = 0; i < cars.length; i++) {
    console.log(`mobil dari index ke${i}, tahun ke ${result[i].year}`);
      // if(cars[i].year) {
      //   result.push;
      // }
  }
