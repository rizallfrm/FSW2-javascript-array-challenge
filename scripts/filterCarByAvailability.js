...
// Panggil fungsi setelah carsData dideklarasikan
filterCarByAvailability(carsData);
...
function filterCarByAvailability(cars) {
  ...
  for (let i = 0; i < cars.length; i++) {
      // console.log(`mobil indeks ke: ${i},${cars[i].type}`);
      // console.log(`mobil indeks ke: ${i},${cars[i].available}`);
    if(cars[i].available) {
      result.push(cars[i]);
    }
  }
